    ...
    <div>
      <ResponsiveContainer width="100%" height={260}>
        <AreaChart
          ...
          onClick={(e) => {
            if (e?.activeLabel) router.push(`/transactions?dateFrom=${e.activeLabel}&dateTo=${e.activeLabel}`);
          }}
      ...
      <p className="mt-1 text-center text-xs text-muted">Klik grafik untuk lihat transaksi pada tanggal tersebut.</p>
    </div>
  );
}
